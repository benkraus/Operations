Pod::Spec.new do |s|
	...
	s.homepage	= "https://github.com/benkraus/Operations"
	s.license	= { :type => 'MIT' }
	s.author	= "Ben Kraus"
	...
	s.source 	= {  git: "https://github.com/benkraus/Operations.git",  tag: s.version.to_s  }
	s.source_files = 'Operations/**/*.swift'
end
